...
const variantClasses = {
  [SfButtonVariant.primary]:
    'text-white shadow hover:shadow-md active:shadow bg-black hover:bg-black active:bg-black disabled:bg-disabled-300',
...
const ExperimentalButton = polymorphicForwardRef<typeof defaultButtonTag, SfButtonProps>((props, ref) => {
  const {
    as,
    className,
