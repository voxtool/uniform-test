...
import ExperimentalButton from './ExperimentalButton';
  ...
  const CustomArticleRight: React.FC<ArticleProps> = ({ testArticle, headingTest }: ArticleProps) => {
    console.log('testArticle', testArticle)
    return (
        <div className="flex flex-col md:flex-row flex-wrap gap-6 max-w-[1000px] mt-2">
        <div
  ...
  registerUniformComponent({
    type: "testVariants",
    variantId: 'right',
    component: CustomArticleRight,
  });
  
  
  export default CustomArticleRight;